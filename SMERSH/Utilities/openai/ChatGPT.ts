    ...
    public constructor(apiKey: string, prompt?: string) {
        ...
        this.prompt = prompt ?? `
            ...
            these are our server rules:
                ...
                14. Certain abuse of roles such as MG42 or badly performing squad leader may result in a roleban, automatically kicking you if you pick the role.
            `
