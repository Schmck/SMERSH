, DiscordRole.Veteran, DiscordRole.Regularimport { CommandInteraction, ApplicationCommandType, ApplicationCommandOptionType, AutocompleteInteraction } from "discord.js";
...
export const CamperCommand: Command = {
    name: "camper",
    aliases: ["c"],
